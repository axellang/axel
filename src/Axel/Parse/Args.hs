...
data ProjectCommand = FormatProject |RunProject 
...
projectCommandParser  = (asum [formatProjectCommand,runProjectCommand]) where {formatProjectCommand  = (command' "format" (info (pure FormatProject) (progDesc "Format the project")));runProjectCommand  = (command' "run" (info (pure RunProject) (progDesc "Build and run the project")))}
