...
denormalizeExpression :: Expression ann -> SM.Expression
denormalizeExpression (ECaseBlock caseBlock) =
  let denormalizedCases =
   ...
   in Parse.SExpression Parse.AutoGenerated $
      ...
      denormalizedCases
denormalizeExpression (EEmptySExpression _) =
...
denormalizeExpression (EIdentifier _ x) = Parse.Symbol Parse.AutoGenerated x
...
denormalizeExpression (ELiteral x) =
  case x of
    LChar _ char -> Parse.LiteralChar Parse.AutoGenerated char
    LInt _ int -> Parse.LiteralInt Parse.AutoGenerated int
    LString _ string -> Parse.LiteralString Parse.AutoGenerated string
denormalizeExpression (ERawExpression _ rawSource) =
  Parse.SExpression
    Parse.AutoGenerated
...
denormalizeImportSpecification :: ImportSpecification ann -> SM.Expression
denormalizeImportSpecification (ImportAll _) =
...
denormalizeImportSpecification (ImportOnly _ importList) =
  ...
  where
    denormalizeImport (ImportItem _ item) =
      Parse.Symbol Parse.AutoGenerated item
    denormalizeImport (ImportType _ type' items) =
      Parse.SExpression
        Parse.AutoGenerated
        (Parse.Symbol Parse.AutoGenerated type' :
         map (Parse.Symbol Parse.AutoGenerated) items)

denormalizeStatement :: Statement ann -> SM.Expression
denormalizeStatement (SDataDeclaration dataDeclaration) =
  let denormalizedTypeDefinition =
        case dataDeclaration ^. typeDefinition of
          ...
          ProperType _ properType -> Parse.Symbol Parse.AutoGenerated properType
   in Parse.SExpression
        Parse.AutoGenerated
...
denormalizeStatement (SModuleDeclaration _ identifier) =
  Parse.SExpression
    Parse.AutoGenerated
...
denormalizeStatement (SRawStatement _ rawSource) =
  Parse.SExpression
    Parse.AutoGenerated
    [ Parse.Symbol Parse.AutoGenerated "raw"
    , Parse.LiteralString Parse.AutoGenerated rawSource
...
denormalizeStatement (STopLevel (TopLevel _ statements)) =
  Parse.SExpression Parse.AutoGenerated $
...
denormalizeStatement (SUnrestrictedImport _ identifier) =
  Parse.SExpression
    Parse.AutoGenerated
