...
expandDo' ((:) (AST.SExpression _ [(AST.Symbol _ "<-"),var,val]) rest) = (AST.SExpression (GHCPrelude.Just ((,) "src/Axel.axel" (SM.Position 41 8))) (concat [[(AST.Symbol (GHCPrelude.Just ((,) "axelTemp/410133631878902096/result.axel" (SM.Position 2 157))) ">>=")],[val],[(AST.SExpression (GHCPrelude.Just ((,) "src/Axel.axel" (SM.Position 41 18))) (concat [[(AST.Symbol (GHCPrelude.Just ((,) "axelTemp/410133631878902096/result.axel" (SM.Position 2 255))) "\\")],[(AST.SExpression (GHCPrelude.Just ((,) "src/Axel.axel" (SM.Position 41 21))) (concat [[var]]))],[(expandDo' rest)]]))]]))
expandDo' ((:) (AST.SExpression _ ((:) (AST.Symbol _ "let") bindings)) rest) = (AST.SExpression (GHCPrelude.Just ((,) "src/Axel.axel" (SM.Position 43 8))) (concat [[(AST.Symbol (GHCPrelude.Just ((,) "axelTemp/410133631878902096/result.axel" (SM.Position 3 161))) "let")],[(AST.SExpression (GHCPrelude.Just ((,) "src/Axel.axel" (SM.Position 43 13))) (concat [(AST.toExpressionList bindings)]))],[(expandDo' rest)]]))
expandDo' ((:) val rest) = (case rest of {[] -> val;_ -> (AST.SExpression (GHCPrelude.Just ((,) "src/Axel.axel" (SM.Position 47 13))) (concat [[(AST.Symbol (GHCPrelude.Just ((,) "axelTemp/410133631878902096/result.axel" (SM.Position 4 138))) ">>")],[val],[(expandDo' rest)]]))})
...
aXEL_SYMBOL_BACKSLASH_case_AXEL_AUTOGENERATED_MACRO_DEFINITION cases = (fmap (\varId -> [(AST.SExpression (GHCPrelude.Just ((,) "src/Axel.axel" (SM.Position 66 15))) (concat [[(AST.Symbol (GHCPrelude.Just ((,) "axelTemp/3437999702307350891/result.axel" (SM.Position 1 127))) "\\")],[(AST.SExpression (GHCPrelude.Just ((,) "src/Axel.axel" (SM.Position 66 18))) (concat [[varId]]))],[(AST.SExpression (GHCPrelude.Just ((,) "src/Axel.axel" (SM.Position 66 27))) (concat [[(AST.Symbol (GHCPrelude.Just ((,) "axelTemp/3437999702307350891/result.axel" (SM.Position 1 314))) "case")],[varId],(AST.toExpressionList cases)]))]]))]) gensym)
