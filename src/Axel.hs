...
expandDo' ((:) (AST.SExpression _ [(AST.Symbol _ "<-"),var,val]) rest) = (AST.SExpression (Just ((,) "src/Axel.axel" (SM.Position 50 8))) (concat [[(AST.Symbol (Just ((,) "axelTemp/6707895515281554179/result.axel" (SM.Position 1 149))) ">>=")],[val],[(AST.SExpression (Just ((,) "src/Axel.axel" (SM.Position 50 18))) (concat [[(AST.Symbol (Just ((,) "axelTemp/6707895515281554179/result.axel" (SM.Position 1 236))) "\\")],[(AST.SExpression (Just ((,) "src/Axel.axel" (SM.Position 50 21))) (concat [[var]]))],[(expandDo' rest)]]))]]))
expandDo' ((:) (AST.SExpression _ ((:) (AST.Symbol _ "let") bindings)) rest) = (AST.SExpression (Just ((,) "src/Axel.axel" (SM.Position 52 8))) (concat [[(AST.Symbol (Just ((,) "axelTemp/6707895515281554179/result.axel" (SM.Position 2 153))) "let")],[(AST.SExpression (Just ((,) "src/Axel.axel" (SM.Position 52 13))) (concat [(AST.toExpressionList bindings)]))],[(expandDo' rest)]]))
expandDo' ((:) val rest) = (case rest of {[] -> val;_ -> (AST.SExpression (Just ((,) "src/Axel.axel" (SM.Position 56 13))) (concat [[(AST.Symbol (Just ((,) "axelTemp/6707895515281554179/result.axel" (SM.Position 3 127))) ">>")],[val],[(expandDo' rest)]]))})
...
def_AXEL_AUTOGENERATED_MACRO_DEFINITION ((:) name ((:) typeSig cases)) = (pure (snoc (map (\x -> (AST.SExpression (Just ((,) "src/Axel.axel" (SM.Position 30 32))) (concat [[(AST.Symbol (Just ((,) "axelTemp/9115882764568914595/result.axel" (SM.Position 1 141))) "=")],[name],(AST.toExpressionList x)]))) cases) (AST.SExpression (Just ((,) "src/Axel.axel" (SM.Position 32 20))) (concat [[(AST.Symbol (Just ((,) "axelTemp/9115882764568914595/result.axel" (SM.Position 1 262))) "::")],[name],[typeSig]]))))
syntaxPattern_AXEL_AUTOGENERATED_MACRO_DEFINITION [pattern] = (pure [(bottomUpFmap (\expr -> (case expr of {(AST.SExpression _ [(AST.Symbol _ "quote"),x]) -> (AST.SExpression (Just ((,) "src/Axel.axel" (SM.Position 41 14))) (concat [[(AST.Symbol (Just ((,) "axelTemp/3621346920235683494/result.axel" (SM.Position 1 200))) "applyInfix")],[(AST.Symbol (Just ((,) "axelTemp/3621346920235683494/result.axel" (SM.Position 1 214))) "unit")],[(AST.Symbol (Just ((,) "axelTemp/3621346920235683494/result.axel" (SM.Position 1 222))) "<$")],[expr]]));_ -> expr})) pattern)])
do'_AXEL_AUTOGENERATED_MACRO_DEFINITION input = (pure [(expandDo' input)])
aXEL_SYMBOL_BACKSLASH_case_AXEL_AUTOGENERATED_MACRO_DEFINITION cases = (fmap (\varId -> [(AST.SExpression (Just ((,) "src/Axel.axel" (SM.Position 75 15))) (concat [[(AST.Symbol (Just ((,) "axelTemp/523139651570005385/result.axel" (SM.Position 1 116))) "\\")],[(AST.SExpression (Just ((,) "src/Axel.axel" (SM.Position 75 18))) (concat [[varId]]))],[(AST.SExpression (Just ((,) "src/Axel.axel" (SM.Position 75 27))) (concat [[(AST.Symbol (Just ((,) "axelTemp/523139651570005385/result.axel" (SM.Position 1 281))) "case")],[varId],(AST.toExpressionList cases)]))]]))]) gensym)
